...
def normalize_llm_decision(decision: Any) -> IntentDecision:
    ...
    if isinstance(decision, IntentDecision):
        ...
        normalized = IntentDecision(
            ...
            clarification=str(getattr(decision, "clarification", "") or ""),
            ...
            use_pending_image=bool(getattr(decision, "use_pending_image", False)),
        )
    ...
    if image_query_mode not in {"unused", "multimodal"}:
    ...
    return IntentDecision(
        ...
        clarification=str(normalized.clarification or ""),
        ...
        use_pending_image=bool(normalized.use_pending_image),
    )
